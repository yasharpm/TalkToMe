...
public class JalaliCalendar extends Calendar {
    ...
    public JalaliCalendar(long time) {
    ...
    public static JalaliCalendar newInstanceFromGregorian(Date from) {
        Calendar gregorianCalendar = Calendar.getInstance();
        gregorianCalendar.setTime(from);
        YearMonthDate yearMonthDate = new YearMonthDate(gregorianCalendar.get(Calendar.YEAR), gregorianCalendar.get(Calendar.MONTH)
                , gregorianCalendar.get(Calendar.DAY_OF_MONTH));
        yearMonthDate = gregorianToJalali(yearMonthDate);
        return new JalaliCalendar(yearMonthDate.getYear(), yearMonthDate.getMonth(), yearMonthDate.getDate());
    }
